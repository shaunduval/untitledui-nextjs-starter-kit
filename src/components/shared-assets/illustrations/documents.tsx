		...
		<div {...otherProps} className={cx("relative h-30 w-40.25", className)}>
			...
			>
				...
				<g filter="url(#documents-shadow-02-sm)">
					...
					/>
					<path
						d="M93.6226 8L103.625 18.0022H93.6226V8Z"
						className="fill-utility-gray-200"
					/>
				</g>
		...
		<div {...otherProps} className={cx("relative h-34.25 w-46.25", className)}>
			...
			>
				...
				<g filter="url(#documents-shadow-01-md)">
					...
					/>
					<path
						d="M56.2523 15.0952L72.1994 20.8995L61.3237 25.9709L56.2523 15.0952Z"
						className="fill-utility-gray-200"
					/>
				</g>
				...
				<g filter="url(#documents-shadow-03-md)">
					...
					/>
					<path
						d="M158.564 26.9048L164.369 42.8519L153.493 37.7805L158.564 26.9048Z"
						className="fill-utility-gray-200"
					/>
				</g>
				...
				<defs>
					...
					>
						...
						<feMorphology
							...
							operator="erode"
							in="SourceAlpha"
							result="effect1_dropShadow_1182_2009"
						/>
						<feOffset dy="3" />
						<feGaussianBlur stdDeviation="1.5" />
						<feColorMatrix
						...
						<feMorphology
							...
							operator="erode"
							in="SourceAlpha"
							result="effect2_dropShadow_1182_2009"
						/>
						<feOffset dy="8" />
						<feGaussianBlur stdDeviation="4" />
						<feColorMatrix
						...
						<feBlend
							mode="normal"
							in2="effect1_dropShadow_1182_2009"
							result="effect2_dropShadow_1182_2009"
						/>
						<feColorMatrix
							in="SourceAlpha"
						...
						<feMorphology
							...
							operator="erode"
							in="SourceAlpha"
							result="effect3_dropShadow_1182_2009"
						/>
						<feOffset dy="20" />
						<feGaussianBlur stdDeviation="12" />
						<feColorMatrix
						...
						<feBlend
							mode="normal"
							in2="effect2_dropShadow_1182_2009"
							result="effect3_dropShadow_1182_2009"
						/>
						<feBlend
							mode="normal"
							in="SourceGraphic"
							in2="effect3_dropShadow_1182_2009"
							result="shape"
						/>
					</filter>
					<filter
		...
		<div {...otherProps} className={cx("relative h-41.5 w-57.5", className)}>
			...
			>
				...
				<g filter="url(#documents-shadow-01-lg)">
					...
					/>
					<path
						d="M67.123 18.7017L88.0984 26.3361L73.7935 33.0066L67.123 18.7017Z"
						className="fill-utility-gray-200"
					/>
				</g>
				<g filter="url(#documents-shadow-02-lg)">
					...
					/>
					<path
						d="M136.503 12L152.286 27.7837H136.503V12Z"
						className="fill-utility-gray-200"
					/>
				</g>
				<g filter="url(#documents-shadow-03-lg)">
					...
					/>
					<path
						d="M201.695 34.2349L209.329 55.2102L195.024 48.5398L201.695 34.2349Z"
						className="fill-utility-gray-200"
					/>
				</g>
				...
				<defs>
					...
					>
						...
						<feMorphology
							...
							operator="erode"
							in="SourceAlpha"
							result="effect1_dropShadow_1182_2741"
						/>
						<feOffset dy="3" />
						<feGaussianBlur stdDeviation="1.5" />
						<feColorMatrix
						...
						<feMorphology
							...
							operator="erode"
							in="SourceAlpha"
							result="effect2_dropShadow_1182_2741"
						/>
						<feOffset dy="8" />
						<feGaussianBlur stdDeviation="4" />
						<feColorMatrix
						...
						<feBlend
							mode="normal"
							in2="effect1_dropShadow_1182_2741"
							result="effect2_dropShadow_1182_2741"
						/>
						<feColorMatrix
							in="SourceAlpha"
						...
						<feMorphology
							...
							operator="erode"
							in="SourceAlpha"
							result="effect3_dropShadow_1182_2741"
						/>
						<feOffset dy="20" />
						<feGaussianBlur stdDeviation="12" />
						<feColorMatrix
						...
						<feBlend
							mode="normal"
							in2="effect2_dropShadow_1182_2741"
							result="effect3_dropShadow_1182_2741"
						/>
						<feBlend
							mode="normal"
							in="SourceGraphic"
							in2="effect3_dropShadow_1182_2741"
							result="shape"
						/>
					</filter>
					<filter
