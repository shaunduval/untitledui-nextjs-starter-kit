		...
		<div {...otherProps} className={cx("relative h-31.5 w-38", className)}>
			...
			>
				...
				<g filter="url(#box-shadow-sm)">
					<path
						d="M76.0006 92.1898L118 73.5312V20.375L76.3298 2L34 20.375V73.5312L76.0006 92.1898Z"
						className="fill-utility-gray-50"
					/>
					<path
					...
					/>
					<path
						d="M76 38.0629V92.2344L34 73.5312V20.375L76 38.0629Z"
						className="fill-utility-gray-200"
					/>
					<path
						d="M76.0008 38.0938V92.2344L118 73.5312V20.375L76.0008 38.0938Z"
						fill="url(#box-gradient-sm)"
					/>
					<path
						d="M76 38.0938L118 20.375L76.3298 2L34 20.375L76 38.0938Z"
						className="fill-utility-gray-50"
					/>
					<path
				...
				<defs>
					...
					>
						...
						<feBlend
							mode="normal"
							in2="box-shadow-sm-effect2"
							result="box-shadow-sm-effect3"
						/>
						<feBlend
							mode="normal"
							in="SourceGraphic"
							in2="box-shadow-sm-effect3"
							result="shape"
						/>
					</filter>
					<linearGradient
		...
		<div {...otherProps} className={cx("relative h-37 w-43", className)}>
			...
			>
				...
				<g filter="url(#box-shadow-md)">
					<path
						d="M86.0007 113.664L138 90.5625V24.75L86.4084 2L34 24.75V90.5625L86.0007 113.664Z"
						className="fill-utility-gray-50"
					/>
					<path
					...
					/>
					<path
						d="M86 46.6493V113.719L34 90.5625V24.75L86 46.6493Z"
						className="fill-utility-gray-200"
					/>
					<path
						d="M86.001 46.6875V113.719L138 90.5625V24.75L86.001 46.6875Z"
						fill="url(#box-gradient-md)"
					/>
					<path
						d="M86 46.6875L138 24.75L86.4084 2L34 24.75L86 46.6875Z"
						className="fill-utility-gray-50"
					/>
					<path
				...
				<defs>
					...
					>
						...
						<feBlend
							mode="normal"
							in2="box-shadow-md-effect2"
							result="box-shadow-md-effect3"
						/>
						<feBlend
							mode="normal"
							in="SourceGraphic"
							in2="box-shadow-md-effect3"
							result="shape"
						/>
					</filter>
					<linearGradient
		...
		<div {...otherProps} className={cx("relative h-45.25 w-55", className)}>
			...
			>
				...
				<g filter="url(#box-shadow-lg)">
					<path
						d="M110.001 139.432L174 111V30L110.503 2L46 30V111L110.001 139.432Z"
						className="fill-utility-gray-50"
					/>
					<path
					...
					/>
					<path
						d="M110 56.9531V139.5L46 111V30.0001L110 56.9531Z"
						className="fill-utility-gray-200"
					/>
					<path
						d="M110.001 57V139.5L174 111V30L110.001 57Z"
						fill="url(#box-gradient-lg)"
					/>
					<path
						d="M110 57L174 30L110.503 2L46 30L110 57Z"
						className="fill-utility-gray-50"
					/>
					<path
				...
				<defs>
					...
					>
						...
						<feBlend
							mode="normal"
							in2="box-shadow-lg-effect2"
							result="box-shadow-lg-effect3"
						/>
						<feBlend
							mode="normal"
							in="SourceGraphic"
							in2="box-shadow-lg-effect3"
							result="shape"
						/>
					</filter>
					<linearGradient
